...
Starting with version 9.0 Gradle will refuse to run builds where any project directory is missing or read-only.
...
project(":project-without-directory").projectDir.mkdir()
----
======
[.multi-language-sample]
======
